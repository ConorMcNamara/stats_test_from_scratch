...
class TestRankTest:
    ...
    def test_twoSampleWilcoxon_unequalLength_Error(self) -> None:
        sample_data1 = [1, 2, 3]
        sample_data2 = [1, 2]
    ...
    def test_friedmanTest_kLessThree_Error(self) -> None:
        sample_data1 = [1, 2, 3]
        sample_data2 = [1, 2, 3]
    ...
    def test_quadeTest_kLessThree_Error(self) -> None:
        sample_data_1 = [1, 2, 3]
        sample_data_2 = [2, 4, 6]
    ...
    def test_pageTrendTest_alternativeTwoSided_Error(self) -> None:
        sample_data1 = [1, 2, 3]
        sample_data2 = [1, 2, 3]
        sample_data3 = [1, 2, 3]
    ...
    def test_kruskalWallisTest_gLessTwo_Error(self) -> None:
        sample_data = [1, 2, 3]
    ...
    def test_kruskalWallis_pResult(self) -> None:
        x1 = [27, 2, 4, 18, 7, 9]
        x2 = [20, 8, 14, 36, 21, 22]
        x3 = [34, 31, 3, 23, 30, 6]
