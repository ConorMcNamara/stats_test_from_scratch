...
class TestOutliersTest:
    ...
    def test_ESD_numOutliersNotInt_Error(self) -> None:
        data = [1, 2, 3, 4]
    ...
    def test_ESD_numOutliersLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
    ...
    def test_ESD_numOutliersGreaterN_Error(self) -> None:
        data = [1, 2, 3, 4]
    ...
    def test_ESD_alphaGreaterOne_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Alpha level must be within 0 and 1"):
            extreme_studentized_deviate_test(data, num_outliers=1, alpha=1.2)

    def test_ESD_alphaLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Alpha level must be within 0 and 1"):
    ...
    def test_TietjenMooreTest_numOutliersLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Cannot test for negative amount of outliers"):
            tietjen_moore_test(data, num_outliers=-1)

    def test_TietjenMooreTest_numOutliersNotInt_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(TypeError, match="Number of outliers must be an integer"):
            tietjen_moore_test(data, num_outliers=1.5)

    def test_TietjenMooreTest_alphaLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Alpha level must be within 0 and 1"):
            tietjen_moore_test(data, alpha=-1.2)

    def test_TietjenMooreTest_alphaGreaterOne_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Alpha level must be within 0 and 1"):
            tietjen_moore_test(data, alpha=1.2)
    ...
    def test_PeirceTest_numOutliersGreaterN_Error(self) -> None:
        data = [1, 2, 3, 4]
        expected = [1, 4, 9, 16]
        with pytest.raises(ValueError, match="Cannot have number of outliers greater than number of observations"):
            peirce_test(data, expected, num_outliers=5)

    def test_PeirceTest_ObservedNotEqualExpected_Error(self) -> None:
        data = [1, 2, 3, 4]
        expected = [1, 4, 9]
        with pytest.raises(ValueError, match="Length of observed and expected need to be the same"):
            peirce_test(data, expected, num_outliers=1)

    def test_PeirceTest_numCoefNotInt_Error(self) -> None:
        data = [1, 2, 3, 4]
        expected = [1, 4, 9, 16]
    ...
    def test_PeirceTest_numCoefLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
        expected = [1, 4, 9, 16]
    ...
    def test_DixonQTest_alphaWrong_Error(self) -> None:
    ...
    def test_DixonQTest_results(self) -> None:
    ...
    def test_DixonQTest_emptyResults(self) -> None:
        data = [0.189, 0.167, 0.187, 0.183, 0.186, 0.182, 0.181, 0.184, 0.181, 0.177]
        assert len(dixon_q_test(data)) == 0

    # Thompson Tau Test

    def test_ThompsonTauTest_alphaLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
    ...
    def test_ThompsonTauTest_alphaGreaterOne_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Cannot have alpha level greater than 1 or less than 0"):
            thompson_tau_test(data, alpha=1.2)

    def test_ThompsonTauTest_noResults(self) -> None:
        data = [48.9, 49.2, 49.2, 49.3, 49.3, 49.8, 49.9, 50.1, 50.2, 50.5]
        assert len(thompson_tau_test(data, 0.05)) == 0

    def test_ThompsonTauTest_result(self) -> None:
        data = [9, 10, 10, 10, 11, 50]
        np.testing.assert_array_equal(thompson_tau_test(data), [50])

    # MAD-median Test
    def test_madMedian_alphaLessZero_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Cannot have alpha level greater than 1 or less than 0"):
            mad_median_test(data, alpha=-0.5)

    def test_madMedian_alphaGreaterOne_Error(self) -> None:
        data = [1, 2, 3, 4]
        with pytest.raises(ValueError, match="Cannot have alpha level greater than 1 or less than 0"):
